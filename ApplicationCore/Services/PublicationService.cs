...
namespace ApplicationCore.Services
{
    public class PublicationService : IPublicationService
    {
        ...
        public async Task RemoveCommentFromBlogPost(Guid blogPostId, Comment comment)
        {
            var spec = new BlogPostWithCommentsSpecification(blogPostId);
            var blogPost = await _blogPostRepository.FirstOrDefaultAsync(spec);
